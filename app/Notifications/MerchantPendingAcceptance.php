...
class MerchantPendingAcceptance extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        // list) even when the merchant has no device_id to push to, or
        // when the OneSignal push itself fails. Previously this whole
        // block only ran inside "if device_id" AND only returned data
        // if the push send succeeded — so a merchant with no push token
