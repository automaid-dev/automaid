...
class SettlementController extends Controller
{
     ...
     * rider, most recent first — used for the app's Settlement
     * History screen.
    ...
    public function detail(Request $request)
    {
        try {
            ...
            // Scoped to this user's own settlements — a rider must
            // never be able to view another rider's payout receipt by
            // guessing/enumerating a hashslug.
