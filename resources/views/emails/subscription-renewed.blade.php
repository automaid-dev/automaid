...
@section('content')
    ...
    <p>
        Thank you for renewing your subscription! Below is your renewal invoice:
    </p>
    ...
    <table class="custom-table">
        ...
        <tr>
            <td class="first-column"><strong>New Billing Date</strong></td>
    ...
    <p style="margin-top: 30px;">
        We're happy to continue serving you. If you have any questions or concerns, feel free to contact our support team.
    </p>
