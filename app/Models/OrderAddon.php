...
class OrderAddon extends Model implements Auditable
{
    ...
    protected static function booted() {
        static::creating(function ($model) {
            $hashids = Sqids::make()->alphabet(config('services.sqids.alphabet'))->minLength(15)->salt('order_addons');
            do {
    ...
    {
        return $this->hasOne('App\Models\AddOn', 'id', 'addon_id');
    }
