...
class RiderPickupWashOutlet extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ...
                    ->line('Clean laundry is waiting at the outlet. Let\'s deliver that freshness!')
    ...
    public function toArray(object $notifiable): array
    {
        $data = [
            ...
            'message' => '🚨 Clean laundry is waiting at the outlet. Let\'s deliver that freshness!',
        ];
        ...
        if ($this->user->device_id) {
            try {
                ...
                \Log::error('push notification failed', ['error' => $th->getMessage(), 'notification' => 'RiderPickupWashOutlet']);
            }
        }
