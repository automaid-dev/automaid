...
class MerchantAdminAssignOrder extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        // build message first — this still needs to be saved to the
        // database notifications table (for the in-app notification
        // list) even when the merchant has no device_id to push to.
        $data = [
            'title' => '📦 New Order Assigned',
            'message' => "You are assigned order #{$this->job->order_id} by admin.",
        ];
